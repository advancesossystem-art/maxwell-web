    ...
    <div className={className}>
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
        <a
          ...
          className="inline-flex h-12 items-center justify-center rounded-full bg-violet-600 px-8 text-base font-semibold text-white shadow-lg shadow-violet-600/30 transition hover:bg-violet-500"
          onClick={() => trackCTAClick("Hero Request Quote", homeHero.primaryCta.href)}
        >
        ...
        <a
          ...
          className="inline-flex h-12 items-center justify-center gap-2 rounded-full border-2 border-emerald-500 bg-transparent px-7 text-base font-semibold text-emerald-400 transition hover:bg-emerald-500/10"
