...
export function IconERP({ className }: IconProps) {
  return (
    <svg className={cn("h-6 w-6", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function IconSaaS({ className }: IconProps) {
  return (
    <svg className={cn("h-6 w-6", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-3.76-3.76 1.5 1.5 0 00-1.5-1.5H5.25A4.5 4.5 0 002.25 15z" />
    </svg>
  );
}
...
export function IconDesign({ className }: IconProps) {
  return (
    <svg className={cn("h-6 w-6", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-2.21-1.79-4-4-4s-4 1.79-4 4c0 .66.16 1.28.445 1.832M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  );
}
...
/** Official WhatsApp brand glyph (single compound path). Use fill via `className` (e.g. fill-[#25D366]). */
