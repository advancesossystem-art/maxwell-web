...
export const chemicalManufacturerSeo = {
  ...
  keywords: [
    ...
    "chemical manufacturer website",
    "chemical company website India",
    "industrial chemical supplier website",
    "chemical manufacturer website Vadodara",
    "MSDS product page chemical website",
    "chemical website development Gujarat",
    "Bharuch Ankleshwar chemical website",
    "B2B chemical website India",
...
export const pharmaceuticalSeo = {
  ...
  keywords: [
    ...
    "pharma company website India",
    "pharmaceutical manufacturer website Vadodara",
    "API supplier website India",
    "medicine company website Gujarat",
    "pharma website development Vadodara",
    "WHO-GMP website India",
    "pharmaceutical exporter website",
    "B2B pharma website Gujarat",
...
export const engineeringSeo = {
  ...
  keywords: [
    ...
    "CNC machining company website India",
    "fabrication company website Vadodara",
    "GIDC company website development",
    "precision engineering website India",
    "manufacturer website Vadodara",
    "industrial engineering website Gujarat",
    "RFQ website engineering company",
    "machine shop website India",
    "engineering exporter website Gujarat",
  ],
} as const;
...
export const textileSeo = {
  ...
  keywords: [
    ...
    "textile company website India",
    "fabric manufacturer website Surat",
    "yarn supplier website India",
    "garment exporter website Gujarat",
    "textile website development Surat",
    "fabric exporter website India",
    "B2B textile website Gujarat",
    "textile catalog website India",
...
export const ceramicSeo = {
  ...
  keywords: [
    ...
    "ceramic company website Morbi",
    "tile manufacturer website India",
    "sanitary ware company website Gujarat",
    "vitrified tile exporter website India",
    "ceramic exporter website Morbi",
    "tile catalog website India",
    "Morbi ceramic website development",
    "B2B ceramic website Gujarat",
    "manufacturer website India export",
  ],
} as const;
...
export const foodProcessingSeo = {
  ...
  keywords: [
    ...
    "FSSAI manufacturer website",
    "packaged food company website",
    "food exporter website India",
    "food manufacturer website development",
    "FSSAI certified company website",
    "food product catalog website India",
    "food processing website Gujarat",
  ],
} as const;
...
export const autoPartsSeo = {
  ...
  keywords: [
    ...
    "automotive supplier website",
    "OEM parts supplier website India",
    "auto component exporter website",
    "auto parts catalog website India",
    "IATF certified supplier website",
    "automobile component website India",
    "auto exporter website Gujarat",
  ],
} as const;
...
export const paintCoatingSeo = {
  ...
  keywords: [
    ...
    "coating manufacturer website",
    "industrial coating supplier website India",
    "paint manufacturer website Gujarat",
    "TDS SDS download website paint",
    "shade card website India",
    "paint distributor website India",
    "industrial paint supplier website",
  ],
} as const;
...
export const plasticManufacturerSeo = {
  ...
  keywords: [
    ...
    "injection molding company website",
    "plastic component supplier website",
    "plastic exporter website Gujarat",
    "HDPE manufacturer website India",
    "plastic catalog website India",
    "PET packaging company website",
    "plastic mold supplier website India",
  ],
} as const;
...
export const exporterIndiaSeo = {
  ...
  keywords: [
    ...
    "export website development India",
    "B2B export website India",
    "manufacturer export website Gujarat",
    "website for trading company India",
...
export const drashtiCaseStudySeo = {
  ...
  keywords: [
    "Drashti Chemicals",
    "chemical supplier Vadodara",
    "chemical manufacturer website Vadodara",
    "industrial chemical supplier Gujarat",
    "manufacturer website case study India",
    "Next.js product catalog website",
    "direct inquiry chemical supplier website",
    "B2B chemical website India",
    "programmatic SEO manufacturer",
    "Vadodara chemical company website",
  ],
} as const;
