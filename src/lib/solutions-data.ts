...
const coreSolutionsData: Record<(typeof coreSolutionSlugs)[number], SolutionPageData> = {
  ...
  "erp-development-company": {
    ...
    metaTitle: "ERP Development Company India — Custom ERP Software",
    metaDescription: `${siteConfig.name} builds custom ERP systems for manufacturing, logistics, and retail. Inventory, production, finance integration. India & global.`,
  ...
  "crm-development-company": {
    ...
    metaDescription: "Custom CRM development by Maxwell Electrodeal. Pipelines, automation, customer portals for B2B sales teams in India and globally.",
  ...
  "website-development-company": {
    ...
    metaTitle: "Website Development Company India — Next.js & React",
    metaDescription: "Enterprise website development company. SEO-optimized, fast, conversion-focused sites by Maxwell Electrodeal. India & global clients.",
  ...
  "ai-development-company": {
    ...
    metaTitle: "AI Development Company India — LLM & Automation",
    metaDescription: "AI development company for LLM chatbots, computer vision, process automation. Maxwell Electrodeal enterprise AI solutions.",
  ...
  "mobile-app-development-company": {
    ...
    metaDescription: "Mobile app development company. React Native, Flutter, iOS, Android. Consumer and enterprise apps by Maxwell Electrodeal.",
  ...
  "saas-development-company": {
    ...
    metaTitle: "SaaS Development Company India — Multi-Tenant Platforms",
    metaDescription: "SaaS development company for startups and enterprises. Multi-tenant, Stripe billing, scalable architecture. Maxwell Electrodeal.",
  ...
  "cloud-solutions-company": {
    ...
    metaTitle: "Cloud Solutions Company India — AWS & Azure",
    metaDescription: "Cloud solutions company. AWS, Azure migration, DevOps, infrastructure. Maxwell Electrodeal enterprise cloud services.",
  ...
  "custom-software-development-company": {
    ...
    metaTitle: "Custom Software Development Company India — Enterprise Apps",
    metaDescription: "Custom software development company in India. Web apps, APIs, integrations, legacy modernization. Maxwell Electrodeal.",
