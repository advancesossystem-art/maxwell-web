...
export const servicesData: Record<ServiceSlug, ServicePageData> = {
  "website-development": {
    ...
    resourceLinks: [
      ...
      { label: "Website Technologies (Next.js)", href: "/services/website-technologies" },
      { label: "Website Redesign", href: "/services/website-redesign" },
      { label: "Web Design", href: "/services/web-design" },
      { label: "Website Maintenance (AMC)", href: "/services/website-maintenance" },
      ...
      { label: "WordPress vs Next.js Guide", href: "/blog/nextjs-vs-wordpress-industrial-website" },
